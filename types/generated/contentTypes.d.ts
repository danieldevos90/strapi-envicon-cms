...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog articles and news items';
    displayName: 'Article';
    pluralName: 'articles';
  ...
  attributes: {
    author: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Envicon'>;
    category: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Projecten'>;
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    social: Schema.Attribute.Component<'ui.social-link', true>;
...
export interface ApiNavigationNavigation extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    logo: Schema.Attribute.Component<'ui.logo', false>;
    menuItems: Schema.Attribute.Component<'ui.menu-item', true>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProcessStepProcessStep extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Steps in the building process';
...
export interface ApiSolutionSolution extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Building solutions (Demontabel, Overkapping, Modulaire, Loods)';
